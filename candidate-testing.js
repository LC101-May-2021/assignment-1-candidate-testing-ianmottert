...
function gradeQuiz(candidateAnswers) {
  ...
  let uppercaseCandidateAnswer = "";
  let uppercaseCorrectAnswer = "";
  let numOfQuestions = 5;

  for (let j = 0; j < candidateAnswers.length; j++) {
    uppercaseCandidateAnswer = candidateAnswers[j].toUpperCase();
    uppercaseCorrectAnswer = correctAnswers[j].toUpperCase();
    if (uppercaseCandidateAnswer == uppercaseCorrectAnswer) {
